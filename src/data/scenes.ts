...
試試看，然後告訴我想怎麼改進！`,
      hints: ['💡 先從簡單功能開始', '💡 逐步增加細節', '💡 描述你想要的效果'],
    },
...
onclick = 點擊時執行
function = 定義動作`,
      tips: ['💡 HTML 像房子結構', '💡 CSS 像裝潢油漆', '💡 JS 像電器開關'],
    },
...
看！具體的錯誤訊息幫助我快速解決！`,
      tips: ['💡 複製錯誤訊息給 AI', '💡 說明你期望的結果', '💡 描述重現步驟'],
    },
