...
const IntroScreen = ({}: IntroScreenProps) => {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="w-full h-screen bg-gradient-to-b from-[#0a0a0a] via-[#111111] to-[#0a0a0a] relative overflow-hidden"
    >
      {/* 背景裝飾 - 科技感光暈 */}
        ...
        <div className="w-full h-full max-w-none mx-auto flex items-center justify-center">
          ...
          <div className="w-full h-full grid lg:grid-cols-[38.2fr_61.8fr] grid-cols-1 lg:grid-rows-1 grid-rows-[auto_1fr] gap-0">
            ...
            <motion.div
              ...
              className="flex flex-col items-center justify-center h-full w-full bg-gradient-to-br from-[#1a1a1a] via-[#141414] to-[#0d0d0d] backdrop-blur-md lg:rounded-none lg:rounded-r-3xl p-4 sm:p-6 md:p-8 lg:p-6 xl:p-8 2xl:p-10 shadow-2xl border-r border-white/5 lg:border-none lg:shadow-none order-2 lg:order-1"
            >
              {/* 登入標題 */}
              <div className="text-center mb-4 sm:mb-6 lg:mb-8 w-full max-w-sm">
                <motion.div
                  ...
                  className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 lg:w-18 lg:h-18 xl:w-20 xl:h-20 bg-gradient-to-br from-emerald-500/20 to-emerald-600/10 rounded-full mb-3 lg:mb-4 shadow-2xl border border-emerald-500/20"
                >
                  <span className="text-2xl sm:text-3xl lg:text-3xl xl:text-4xl">
                    🚀
                  </span>
                </motion.div>
                <h2 className="text-lg sm:text-xl lg:text-xl xl:text-2xl font-bold text-white mb-1 sm:mb-2">
                  歡迎來到 AI 編程世界
                </h2>
                <p className="text-sm lg:text-sm xl:text-base text-gray-500">
                  登入開始你的學習之旅
                </p>
              </div>
              ...
              <div className="w-full max-w-sm lg:max-w-md space-y-3 sm:space-y-4 lg:space-y-5">
                {/* 標籤切換 */}
                <div className="flex p-1 bg-white/5 backdrop-blur rounded-2xl shadow-lg border border-white/10">
                  <button
                    onClick={() =>
                      setIntroState(prev => ({
                        ...prev,
                ...
                <div className="space-y-3 sm:space-y-4">
                      ...
                      >
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            placeholder="輸入你的暱稱"
                            className="w-full pl-10 sm:pl-12 pr-4 py-2.5 sm:py-3 bg-white/5 border border-white/10 rounded-xl sm:rounded-2xl focus:bg-white/10 focus:border-emerald-500/50 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 transition-all text-sm sm:text-base text-white placeholder-gray-500"
                          />
                        </div>
                      </motion.div>
                    )}
                  ...
                  <motion.button
                    ...
                    className="w-full bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-500 hover:to-emerald-400 text-white font-bold py-3 sm:py-3.5 lg:py-4 rounded-xl sm:rounded-2xl transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-xl shadow-emerald-500/20 mt-4 sm:mt-5 lg:mt-6 text-sm sm:text-base"
                  >
                    {loading ? (
                ...
                <div className="mt-3 sm:mt-4 lg:mt-5 text-center">
                  ...
                  >
                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg sm:rounded-xl px-3 py-2 sm:px-4 sm:py-3">
                      <div className="flex items-center justify-center gap-2">
                        ...
                        <motion.span
                          ...
                          className="text-sm sm:text-base font-bold text-emerald-400"
                        >
                  ...
                  >
                    ...
                    <div className="flex gap-2 sm:gap-3">
                      <Link
                        to="/adventure"
                        className="flex-1 flex items-center justify-center gap-2 py-2.5 sm:py-3 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-emerald-500/30 rounded-xl transition-all group"
                      >
                        <Map className="w-4 h-4 text-emerald-400 group-hover:scale-110 transition-transform" />
                        <span className="text-sm font-medium text-gray-300">冒險地圖</span>
                      </Link>
                      <Link
                        to="/playground"
                        className="flex-1 flex items-center justify-center gap-2 py-2.5 sm:py-3 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-emerald-500/30 rounded-xl transition-all group"
                      >
                        ...
                        <span className="text-sm font-medium text-gray-300">Playground</span>
                      </Link>
                    </div>
                  </motion.div>
                </div>
            ...
            <motion.div
              ...
              className="lg:hidden w-full flex flex-col items-center justify-center space-y-3 py-4 sm:py-6 order-1 lg:order-2 min-h-[30vh] bg-gradient-to-br from-[#111111] to-[#0d0d0d]"
            >
              <motion.div
                animate={{
                  y: [0, -8, 0],
                ...
                className="w-24 h-24 sm:w-28 sm:h-28 bg-gradient-to-br from-emerald-500/20 to-emerald-600/10 rounded-full flex items-center justify-center shadow-lg border border-emerald-500/20"
              >
                <span className="text-3xl sm:text-4xl">🐱</span>
              </motion.div>
              <h2 className="text-base sm:text-lg font-bold text-white text-center px-4">
                和 Tororo 一起學習 AI 編程
              </h2>
            </motion.div>
              ...
              <div className="h-full flex flex-col items-center justify-center px-6 lg:px-8 xl:px-12 py-8">
                ...
                >
                  ...
                  <div className="flex items-center justify-center gap-2 lg:gap-3 mb-3 lg:mb-4">
                    <span className="bg-gradient-to-r from-emerald-400 to-emerald-300 bg-clip-text text-transparent text-3xl lg:text-4xl xl:text-5xl font-black">
                      3分鐘
                    </span>
                    <span className="text-gray-400 text-lg lg:text-xl xl:text-2xl font-medium">
                      學會
                    </span>
                    <span className="bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent text-2xl lg:text-3xl xl:text-4xl font-black">
                      AI寫程式
                    </span>
                  </div>
                  <p className="text-gray-500 text-base lg:text-lg xl:text-xl max-w-md mx-auto leading-relaxed">
                ...
                <div className="relative flex-1 flex items-center justify-center w-full max-w-2xl">
                  ...
                  >
                    <div className="relative w-[200px] h-[200px] lg:w-[280px] lg:h-[280px] xl:w-[340px] xl:h-[340px] 2xl:w-[400px] 2xl:h-[400px]">
                      {/* 多層光環效果 */}
                      <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/10 to-emerald-400/10 rounded-full blur-3xl animate-pulse"></div>
                      <div className="absolute inset-4 bg-gradient-to-r from-white/5 to-emerald-500/5 rounded-full blur-2xl"></div>

                      <Suspense
                        fallback={
                          <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-white/5 to-white/[0.02] rounded-full shadow-2xl border border-white/10">
                  ...
                  <div className="absolute inset-0">
                    ...
                    >
                      <div
                        className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-2xl lg:rounded-3xl p-4 lg:p-6 shadow-xl border border-white/10 hover:scale-110 transition-all duration-300 hover:shadow-2xl hover:border-emerald-500/30 cursor-pointer group"
                  ...
                  <div className="absolute inset-0 pointer-events-none">
                    <motion.div
                      ...
                      className="absolute top-1/4 left-1/4 w-2 h-2 bg-emerald-400/40 rounded-full"
                    ></motion.div>
                    <motion.div
                      animate={{
                        y: [0, 25, 0],
                    ...
                    <motion.div
                      ...
                      className="absolute bottom-1/3 left-1/3 w-1.5 h-1.5 bg-emerald-300/40 rounded-full"
                    ></motion.div>
                  </div>
                </div>
              </div>
