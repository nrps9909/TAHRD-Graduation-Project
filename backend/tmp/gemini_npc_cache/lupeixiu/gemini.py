#!/usr/bin/env python3
"""
NPC lupeixiu 專用的 Gemini 執行腳本 - 完整優化版
...
class OptimizedGeminiClient:
    ...
    def __init__(self):
        ...
        self.npc_name = "lupeixiu"
        self.npc_display_name = "陸培修"
    ...
    def _prepare_single_context(self):
        ...
        try:
            ...
            # 1. 人設檔案（注意檔名拼寫）
            personality_file = self.current_dir / "LuPeiXiu_Personality.md"
            ...
            # 2. 對話風格（注意檔名拼寫）
            chat_style_file = self.current_dir / "LuPeiXiu_Chat_style.txt"
